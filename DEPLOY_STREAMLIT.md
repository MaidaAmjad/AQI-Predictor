...
1. Open [share.streamlit.io](https://share.streamlit.io) → your app **maida-aqi-predictor**.
2. Note your **subdomain**, **repo**, **branch**, **main file** (`app/app/streamlit_app.py`), and **Secrets**.
3. **Delete** the app (Manage app → Delete).
4. **Create app** again from the same GitHub repo.
5. Set **Main file path:** `app/app/streamlit_app.py`
